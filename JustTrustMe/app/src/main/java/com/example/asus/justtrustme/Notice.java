...
public class Notice extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener{
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (id) {
            case R.id.other_settings:
                Intent intent1 = new Intent(Notice.this, OtherSettings.class);
                startActivity(intent1);
                break;
            case R.id.logout:
                Intent intent2 = new Intent(Notice.this, Logout.class);
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem menuItem) {
        ...
        if (id == R.id.nav_finding_a_way){
            ...
            Intent intent = new Intent(Notice.this, FindingWay.class);
            startActivity(intent);
        } else if (id == R.id.nav_register_contacts){
            drawer.closeDrawer(GravityCompat.START);
            Intent intent = new Intent(Notice.this, RegisterContacts.class);
            startActivity(intent);
            ...
            drawer.closeDrawer(GravityCompat.START);
            Intent intent = new Intent(Notice.this, FAQ.class);
            startActivity(intent);
        }
        return true;
    }
